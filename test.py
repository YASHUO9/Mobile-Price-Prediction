...
from dataclasses import dataclass # Compare this import statement with the import statement in src/Mobile_Price_Prediction/components/data_transformation.py
...
from src.Mobile_Price_Prediction.utils.utils import save_object
...
class DataTransformation:
    ...
    def get_data_transformation(self):
            ...
            numerical_cols = ['Ratings','RAM','ROM','Mobile_Size','Primary_Cam','Selfi_Cam','Battery_Power','Price']
    ...
    def initialize_data_transformation(self,train_path,test_path):
        try:
            ...
            train_arr = np.c_[input_feature_train_arr, np.array(train_df)]
...
train_data_path = "D:/work/Mobile-Price-Prediction/artifacts/train.csv"
test_data_path = "D:/work/Mobile-Price-Prediction/artifacts/test.csv"
